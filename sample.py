...
class MyFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.tagsConfPath = "C:\\Users\\User\\Desktop\\RINproject\\test.conf"
        self.schedulConfPath = ""
        self.appRootConfPath = "C:\\Users\\User\\Desktop\\RINproject\\app_root.conf"
        ...
        # 規則是 frame 下面第一個一定要放 sizer，雖然可以在 frame 的 sizer 上直接構圖，但是莫名會造成視窗左上角破圖，因此蓋一層 panel 比較美觀
